...
// //Transactions
import CryptoTransactions from '../pages/Crypto/Transactions';
import FinanceTransactions from '../pages/Transactions';
...
const authProtectedRoutes = [
  ...
  // //transactions
  { path: "/apps-crypto-transactions", component: <CryptoTransactions /> },
